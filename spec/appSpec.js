describe('sm-meetApp', function () {
  var $stateProvider, $urlRouterProvider;
  beforeEach(module('sm-meetApp', 'ionic', 'firebase', 'ngCookies'));
  ...
  // it.only('Should have /signup route, template, and controller', function () {
  //   expect($stateProvider.state['/login']).to.be.ok();
